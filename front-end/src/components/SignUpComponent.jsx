...
function SignUpComponent() {
    const handleFormSubmit = async (e) => {
        ...
        try{
            const response = await fetch('http://localhost:5046/sendEmail', {
                method: 'POST',
                headers: {
            ...
            <div className="container px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5">
                    <div className="col-md-10 col-lg-8 mx-auto text-center">
                        ...
                        <form className="form-signup" id="contactForm"  action='http://localhost:5046/sendEmail' method='post' onSubmit={handleFormSubmit}>
                            {/* <!-- Email address input--> */}
